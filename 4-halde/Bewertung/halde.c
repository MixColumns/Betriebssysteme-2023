...
/*I----> +--------------------------------------------------------------------+
         | An diesem Punkt sollte die  errno bereits von eurem malloc gesetzt |
         | worden sein. Und new_ptr sollte returned werden                    |
         +-------------------------------------------------------------------*/
		errno = ENOMEM;
		return NULL;
	}
	...
	// not initialized.
/*I----> +--------------------------------------------------------------------+
         | Hier fehlt ein Check ob size oder tmp->size kleiner ist. Wenn hier |
         | der größere  Wert genutzt  wird sorgt dies  in einigen  Fällen für |
         | Fehler (-1)                                                        |
         +-------------------------------------------------------------------*/
